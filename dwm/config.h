...
static const char *fonts[]          = { "UbuntuMono Nerd Font:size=12", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
...
static const char *brightup[] = { "brillo", "-A", "2", NULL };
static const char *brightdn[] = { "brillo", "-U", "2", NULL };
